...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .companion-group.celebrate .companion {
    animation: cheer 0.55s ease-in-out infinite alternate;
    box-shadow: 0 10px 28px rgba(0,0,0,0.4), 0 0 0 3px var(--green);
  }
  .companion-group.celebrate .companion:nth-child(2) {
...
<body>
  ...
  <div class="companion-caption" id="companionCaption">버스가 도착했어요!</div>
  <div class="companion-group" id="companionGroup">
  <div class="companion">
...
<script>
  ...
  const els = {
    ...
    companionGroup: document.getElementById('companionGroup'),
    companionCaption: document.getElementById('companionCaption'),
  };
  ...
  function render() {
    ...
    // 버스가 실제로 도착했을 때(0초) 동반자 사진이 통통 튀며 말풍선 표시
    const arrived = remaining <= 0;
    els.companionGroup.classList.toggle('celebrate', arrived);
    els.companionCaption.classList.toggle('show', arrived);
  }
